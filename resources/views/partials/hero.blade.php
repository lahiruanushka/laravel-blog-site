    ...
    <div class="container overflow-hidden">
        <div class="row gy-5 gy-lg-0 align-items-lg-center justify-content-lg-between">
            <div class="col-12 col-lg-6 order-1 order-lg-0">
                ...
                <p class="fs-4 mb-5">Dive into a world of knowledge with our comprehensive articles on technology,
                    lifestyle, and more. Join our community and stay updated with the latest trends and ideas.</p>
                @guest
                    <div class="d-grid gap-2 d-sm-flex">
                        <a href="{{ route('register') }}" type="button"
                            class="btn btn-outline-primary bsb-btn-2xl rounded-pill">Register Now</a>
                    </div>
                @endguest
            </div>
            ...
            <div class="col-12 col-lg-5 text-center">
                <div class="position-relative">
                    ...
                    <img class="img-fluid position-relative z-2" loading="lazy"
                        src="{{ asset('images/blog.png') }}" alt="Welcome to Our Blog: Insights on AI and Web 3.0" style="width: 250px">
                </div>
            </div>
        </div>
    </div>
